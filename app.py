...
[data-testid="stSidebar"] { background: #080810 !important; border-right: 1px solid rgba(124,58,237,.2) !important; }
[data-testid="stSidebar"] * { color: #9090C0 !important; }
[data-testid="stSidebar"] .stRadio label { font-size: .875rem !important; font-weight: 500 !important; color: #A0A0D0 !important; padding: 9px 14px !important; border-radius: 9px !important; display: block !important; transition: all .15s !important; margin: 2px 0 !important; }
[data-testid="stSidebar"] .stRadio label:hover { background: rgba(124,58,237,.15) !important; color: #C8B0FF !important; }
[data-testid="stSidebar"] hr { border-color: rgba(124,58,237,.2) !important; }
[data-testid="metric-container"] { background: #12122A !important; border: 1px solid rgba(124,58,237,.3) !important; border-radius: 18px !important; padding: 22px 26px !important; box-shadow: 0 0 30px rgba(124,58,237,.07) !important; }
[data-testid="metric-container"] label { font-size: .7rem !important; font-weight: 700 !important; text-transform: uppercase !important; letter-spacing: .08em !important; color: #7B7BAA !important; }
...
.stButton > button { font-family: 'Inter', sans-serif !important; font-weight: 600 !important; font-size: .855rem !important; border-radius: 10px !important; padding: .5rem 1.4rem !important; border: 1px solid rgba(124,58,237,.3) !important; background: rgba(124,58,237,.1) !important; color: #C4B5FD !important; transition: all .18s !important; }
.stButton > button:hover { border-color: rgba(124,58,237,.7) !important; background: rgba(124,58,237,.22) !important; color: #EDE9FE !important; transform: translateY(-1px) !important; box-shadow: 0 4px 16px rgba(124,58,237,.25) !important; }
.stButton > button[kind="primary"] { background: linear-gradient(135deg, #6D28D9, #8B5CF6) !important; color: #FFFFFF !important; border: none !important; box-shadow: 0 4px 20px rgba(109,40,217,.4) !important; }
.stButton > button[kind="primary"]:hover { background: linear-gradient(135deg, #5B21B6, #7C3AED) !important; box-shadow: 0 6px 28px rgba(109,40,217,.55) !important; color: #FFFFFF !important; }
[data-testid="stTextInput"] input, [data-testid="stNumberInput"] input { background: #0F0F20 !important; border: 1.5px solid rgba(124,58,237,.25) !important; border-radius: 10px !important; color: #E8E8FF !important; font-size: .875rem !important; caret-color: #8B5CF6 !important; }
[data-testid="stTextInput"] input:focus, [data-testid="stNumberInput"] input:focus { border-color: #7C3AED !important; box-shadow: 0 0 0 3px rgba(124,58,237,.2) !important; }
[data-testid="stTextInput"] input::placeholder, [data-testid="stNumberInput"] input::placeholder { color: #5A5A80 !important; }
[data-testid="stTextArea"] textarea { background: #0F0F20 !important; border: 1.5px solid rgba(124,58,237,.25) !important; border-radius: 12px !important; color: #E8E8FF !important; font-size: .875rem !important; line-height: 1.65 !important; caret-color: #8B5CF6 !important; }
[data-testid="stTextArea"] textarea:focus { border-color: #7C3AED !important; box-shadow: 0 0 0 3px rgba(124,58,237,.2) !important; }
...
[data-testid="stSelectbox"] > div > div { background: #0F0F20 !important; border: 1.5px solid rgba(124,58,237,.25) !important; border-radius: 10px !important; color: #E8E8FF !important; }
[data-testid="stSelectbox"] > div > div > div { color: #E8E8FF !important; }
[data-testid="stSelectbox"] svg { fill: #8B5CF6 !important; }
[data-baseweb="popover"], [data-baseweb="menu"], div[role="listbox"], ul[role="listbox"] { background: #1A1A2E !important; border: 1px solid rgba(124,58,237,.35) !important; border-radius: 10px !important; }
li[role="option"] { background: #1A1A2E !important; color: #E8E8FF !important; font-size: .875rem !important; }
li[role="option"]:hover, li[aria-selected="true"] { background: rgba(124,58,237,.2) !important; color: #EDE9FE !important; }
[data-testid="stExpander"] { background: #10101E !important; border: 1px solid rgba(124,58,237,.18) !important; border-radius: 16px !important; margin-bottom: 10px !important; overflow: hidden !important; }
[data-testid="stExpander"] summary { font-weight: 600 !important; font-size: .88rem !important; color: #C8C8F0 !important; padding: 16px 20px !important; background: #10101E !important; letter-spacing: -.01em !important; border-radius: 16px !important; }
[data-testid="stExpander"] summary:hover { background: #16162A !important; }
[data-testid="stExpander"] > div:last-child { padding: 4px 20px 20px !important; background: #10101E !important; }
[data-testid="stExpander"] summary svg { fill: #8B5CF6 !important; }
[data-testid="stNumberInput"] button { background: #1A1A2E !important; color: #8B5CF6 !important; border: 1px solid rgba(124,58,237,.2) !important; border-radius: 8px !important; }
...
[data-testid="stAlert"] { background: rgba(239,68,68,.1) !important; border: 1px solid rgba(239,68,68,.3) !important; border-radius: 12px !important; color: #FCA5A5 !important; font-size: .855rem !important; }
...
[data-testid="stDownloadButton"] > button { background: rgba(124,58,237,.1) !important; border: 1px solid rgba(124,58,237,.3) !important; color: #C4B5FD !important; border-radius: 10px !important; font-weight: 600 !important; }
[data-testid="stDownloadButton"] > button:hover { background: rgba(124,58,237,.22) !important; border-color: rgba(124,58,237,.6) !important; color: #EDE9FE !important; }
...
code { background: rgba(124,58,237,.2) !important; color: #C4B5FD !important; border-radius: 6px !important; padding: 2px 8px !important; font-size: .82rem !important; }
...
def detect_aplus(soup, html_text):
    for aid in ["aplus","aplus3p_feature_div","aplusBrandStory_feature_div",
        ...
        if el and len(el.get_text(strip=True)) > 30: return True
    for cls in ["aplus-v2","aplus-module","a-aplus","aplusBrandStory","aplus-brand-story-hero","aplus-brand-story-card","ap-comparison-table"]:
        found = soup.find(attrs={"class": lambda c, _c=cls: c and _c in (c if isinstance(c,str) else " ".join(c))})
        if found and len(found.get_text(strip=True)) > 30: return True
    ...
    hl = html_text.lower()
    for sig in ['"aplus-v2"',"aplus-module","aplusbrandstory","aplus3p_feature_div","a-aplus","enhanced-brand-content","aplus_feature","aplus-tech-specs"]:
        if sig in hl: return True
    for img in soup.find_all("img", src=True):
        if "aplus" in img.get("src","").lower() or "a-plus" in img.get("src","").lower(): return True
...
def scrape(asin):
    ...
    if r.status_code == 503: raise Exception("Amazon returned 503 — rate limited. Wait a few minutes.")
    if r.status_code != 200: raise Exception("HTTP " + str(r.status_code) + " for ASIN " + asin)
    if "captcha" in r.text.lower() and "robot" in r.text.lower(): raise Exception("CAPTCHA detected — try again in a few minutes.")
    ...
    return {"title": title, "bullets": bullets, "has_aplus": has_aplus, "description": description, "image_url": image_url, "brand": brand}
...
def analyse(scraped, keywords, rule):
    title = scraped.get("title") or ""; bullets = scraped.get("bullets") or []
    has_aplus = scraped.get("has_aplus", False); desc = scraped.get("description") or ""
    ...
    if not title:
        ...
        if ln < rule["title_min_length"]:
            ...
            ti.append("Title too long (" + str(ln) + " chars) \u2014 Amazon may truncate it."); ts += mw * 0.30
        else:
            ts += mw * 0.40
        found_t, _ = kw_split(title, keywords); kr = len(found_t) / len(keywords) if keywords else 1.0
        ts += mw * 0.40 * kr
        ...
        if rule.get("title_keyword_in_first") and keywords:
            if not any(k.lower() in title[:80].lower() for k in keywords[:3]): ti.append("Primary keyword not in first 80 characters.")
            else: ts += mw * 0.20
        if sum(1 for w in title.split() if w.isupper() and len(w) > 2) > 3: ti.append("Too many ALL-CAPS words \u2014 use Title Case.")
    mw2 = rule["bullets_weight"]; bi, bs = [], 0
    if not bullets:
        bi = ["No bullet points found on the product page."]
    else:
        cnt = len(bullets)
        if cnt < rule["bullets_min_count"]: bi.append("Only " + str(cnt) + " bullet(s). Recommended: " + str(rule["bullets_min_count"]) + "."); bs += mw2 * 0.30 * (cnt / rule["bullets_min_count"])
        else: bs += mw2 * 0.30
        ...
        ok = (cnt - len(short) - len(long_)) / cnt; bs += mw2 * 0.30 * ok
        found_b, _ = kw_split(" ".join(bullets), keywords); kr2 = len(found_b) / len(keywords) if keywords else 1.0
        bs += mw2 * 0.40 * kr2
    ...
    if not keywords:
        ks, found_k, miss_k = mw4, [], []; ki = ["No keywords assigned to this product line."]
    else:
        found_k, miss_k = kw_split(all_content, keywords); cov = len(found_k) / len(keywords) * 100
        ks = mw4 * (cov / 100); thresh = rule.get("keywords_min_coverage", 70)
        if cov < thresh: ki.append("Coverage " + str(round(cov)) + "% (target \u2265" + str(round(thresh)) + "%). Missing: " + ", ".join(miss_k[:8]) + ("..." if len(miss_k)>8 else "") + ".")
        if rule.get("keywords_in_title") and keywords:
            ft2, _ = kw_split(title, keywords[:3])
            if not ft2: ki.append("None of the top 3 keywords appear in the title.")
    ...
    existing_l = {k.lower() for k in keywords}; counts = {}
    for t in tokens:
    ...
    return {"total_score": total, "title_score": round(min(ts,mw),1), "bullets_score": round(min(bs,mw2),1),
...
def keyword_gaps(title, bullets_list, pl_keywords):
    tl = (title or "").lower(); bt = " ".join(bullets_list or []).lower()
...
def classify_bullet(bullet):
    ...
    if re.search(r"\b\d+[\.,]?\d*\s*(mm|cm|m|km|kg|g|lb|oz|w|v|mah|l|ml|inch|ft|gb|tb|mhz|ghz|rpm|%)", b): return "specification"
    ...
    if any(q in b for q in ["premium","high-quality","durable","robust","professional","heavy-duty","lightweight","compact","ergonomic"]): return "quality"
...
def smart_rewrite(bullet, keyword):
    b = bullet.strip().rstrip("."); kw = keyword.strip(); kc = kw.capitalize(); bl = b.lower(); words = b.split()
    ...
    if btype == "feature_list":
        for verb in ["features","includes","comes with","equipped with"]:
            if verb in bl:
                ...
                if "," in rest:
                    parts = rest.rsplit(",",1); return b[:idx] + " " + parts[0] + ", " + kw + "," + parts[1] + ".", "feature-list-insert", 88
                if " and " in rest:
                    ai = rest.rindex(" and "); return b[:idx] + " " + rest[:ai] + ", " + kw + rest[ai:] + ".", "feature-list-and", 86
    ...
    if btype == "quality":
        for qa in ["premium","durable","professional","high-quality","robust","lightweight","compact"]:
            if qa in bl:
                qi = bl.index(qa) + len(qa); return b[:qi] + " " + kw + b[qi:] + ".", "quality-adjective", 83
    ...
    if b.count(",") >= 2:
        parts = b.rsplit(",",1); return parts[0] + ", " + kw + "," + parts[1] + ".", "general-comma-insert", 77
    if len(b) < 70: return kc + " \u2014 " + b + ".", "general-category-prefix", 70
    for sep in ["; "," \u2014 "," - ",": "]:
        if sep in b:
            si = b.index(sep); rest = b[si+len(sep):]; return b[:si] + sep + kc + " " + rest + ".", "general-clause-split", 71
...
def bullet_rewrite_suggestions(bullets_list, missing_kws):
    ...
    for kw in missing_kws:
        ...
        kw_words = set(re.findall(r"\b\w{3,}\b", kw.lower())); best_idx, best_score = 0, -1
        for i, bul in enumerate(bullets_list):
            bul_words = set(re.findall(r"\b\w{3,}\b", bul.lower()))
            score = (len(kw_words & bul_words) * 3 + max(0,(300-len(bul))/300) + (0.5 if "," in bul or " and " in bul.lower() else 0))
            if score > best_score: best_score, best_idx = score, i
        orig = bullets_list[best_idx]; sugg, strat, conf = smart_rewrite(orig, kw)
        suggestions.append({"keyword": kw, "bullet_idx": best_idx, "bullet_type": classify_bullet(orig), "original": orig, "suggested": sugg, "strategy": strat, "confidence": conf})
    return suggestions

def build_excel(rows):
    wb = openpyxl.Workbook(); ws = wb.active; ws.title = "Analysis Results"; ws.freeze_panes = "A2"
    hf = Font(bold=True, color="FFFFFF", name="Calibri", size=10)
    hfill = PatternFill("solid", fgColor="12122A"); alt = PatternFill("solid", fgColor="0B0B15")
    thin = Border(bottom=Side(style="thin", color="1E1E3A"))
    hdrs = ["ASIN","Product","Date","Score","Title","Bullets","A+","Keywords","Has A+","Title Missing KWs","Bullets Missing KWs","All Missing KWs","Issues"]
    for c, h in enumerate(hdrs, 1):
        cell = ws.cell(row=1, column=c, value=h); cell.font = hf; cell.fill = hfill; cell.border = thin
        cell.alignment = Alignment(horizontal="center", vertical="center")
    for ri, r in enumerate(rows, 2):
        blist = json.loads(r["bullets"] or "[]"); pl_kws = json.loads(r["pl_keywords"] or "[]") if "pl_keywords" in r.keys() else []
        ...
        vals = [r["asin"], r["product_name"] or "\u2014", str(r["created_at"] or "")[:10],
                ...
                "Yes" if r["has_aplus"] else "No", "; ".join(tm), "; ".join(bm),
                "; ".join(json.loads(r["missing_keywords"] or "[]")),
                "; ".join(json.loads(r["title_issues"] or "[]") + json.loads(r["bullets_issues"] or "[]") + json.loads(r["aplus_issues"] or "[]") + json.loads(r["keywords_issues"] or "[]"))]
        for c, val in enumerate(vals, 1):
            ...
            if c == 4 and val is not None:
                v = float(val); col = ("16A34A" if v>=85 else "CA8A04" if v>=65 else "EA580C" if v>=40 else "DC2626")
...
def score_gauge(s, size=112):
    if s is None: s = 0
    c, bg, tc, lbl = _score_meta(s); pct = max(0, min(100, s)); rem = 100 - pct
...
def score_bar(label, score, max_score, icon=""):
    pct = (score / max_score * 100) if max_score else 0; color = _bar_c(pct)
    return ('<div style="margin:14px 0">'
            ...
            '<div style="background:' + color + ';width:' + str(round(pct,1)) + '%;height:100%;border-radius:999px;box-shadow:0 0 10px ' + color + '66"></div>'
            '</div></div>')

def issue_box(text):
    return ('<div style="display:flex;gap:10px;align-items:flex-start;background:rgba(234,179,8,.09);border:1px solid rgba(234,179,8,.28);border-left:3px solid #EAB308;border-radius:0 10px 10px 0;padding:11px 14px;margin:6px 0;font-size:.83rem;color:#FDE047;line-height:1.55">'
            '<span style="flex-shrink:0">\u26a0\ufe0f</span><span>' + text + '</span></div>')

def ok_box(label):
    return ('<div style="display:flex;gap:9px;align-items:center;background:rgba(34,197,94,.09);border:1px solid rgba(34,197,94,.28);border-left:3px solid #22C55E;border-radius:0 10px 10px 0;padding:11px 14px;margin:6px 0;font-size:.83rem;color:#86EFAC;font-weight:500">'
            '\u2713  ' + label + ' \u2014 no issues found.</div>')

def pill(text, t="found"):
    styles = {"found":"background:rgba(34,197,94,.13);color:#86EFAC;border:1px solid rgba(34,197,94,.32)",
    ...
    return ('<span style="' + s + ';display:inline-flex;align-items:center;gap:4px;border-radius:20px;padding:4px 11px;margin:3px;font-size:.775rem;font-weight:600;line-height:1.4">' + i + '  ' + text + '</span>')

def section_label(text):
    return ('<p style="font-size:.7rem;font-weight:700;text-transform:uppercase;letter-spacing:.09em;color:#7B7BAA;margin:0 0 10px">' + text + '</p>')

def copy_btn(text, uid):
    esc = text.replace("\\","\\\\").replace("'","\\'").replace("\n"," ")
    return ('<button onclick="navigator.clipboard.writeText(\'' + esc + '\');this.innerText=\'\u2713 Copied!\';setTimeout(()=>this.innerText=\'Copy\',2000)" '
            'style="background:rgba(124,58,237,.18);border:1px solid rgba(124,58,237,.4);border-radius:8px;padding:6px 16px;font-size:.775rem;font-weight:600;color:#C4B5FD;cursor:pointer;margin-top:10px;font-family:Inter,sans-serif">Copy</button>')
...
def confidence_badge(conf, strategy):
    ...
    return ('<span style="background:' + bg + ';color:' + c + ';border-radius:8px;padding:3px 9px;font-size:.72rem;font-weight:700;margin-left:8px;border:1px solid ' + c + '44">' + str(conf) + '% \u00b7 ' + strategy + '</span>')
...
def page_header(title, sub=""):
    ...
    show('<div style="margin-bottom:30px;padding-bottom:24px;border-bottom:1px solid rgba(124,58,237,.15)">'
         ...
         '<div style="width:4px;height:32px;background:linear-gradient(180deg,#7C3AED,#C4B5FD);border-radius:4px;box-shadow:0 0 12px rgba(124,58,237,.5)"></div>'
...
def empty_state(icon, title, subtitle):
    show('<div style="background:#10101E;border-radius:20px;padding:56px 24px;border:1px solid rgba(124,58,237,.15);text-align:center;margin:20px 0">'
...
with st.sidebar:
    show('<div style="padding:10px 6px 22px">'
         ...
         '<div style="width:36px;height:36px;background:linear-gradient(135deg,#6D28D9,#8B5CF6);border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:1rem;box-shadow:0 4px 16px rgba(109,40,217,.45)">\U0001f6d2</div>'
         '<div><div style="font-size:.95rem;font-weight:800;color:#EDE9FE;letter-spacing:-.02em">Amazon</div>'
         '<div style="font-size:.95rem;font-weight:800;color:#8B5CF6;letter-spacing:-.02em">Analyser</div></div></div>'
         '<p style="font-size:.68rem;color:#5A5A80;margin:8px 0 0;letter-spacing:.04em">CONTENT \u00b7 SEO \u00b7 UK</p></div>')
    st.markdown("---")
    page = st.radio("Navigation", [
        "\U0001f3e0  Dashboard", "\U0001f50d  New Analysis",
        "\U0001f4dc  History", "\U0001f3f7  Product Lines", "\u2699\ufe0f  Scoring Rules",
    ], label_visibility="collapsed")
    st.markdown("---")
    show('<div style="padding:0 6px">' + section_label("Score guide") +
         "<div style='display:flex;flex-direction:column;gap:7px'>" +
         "".join('<div style="display:flex;align-items:center;gap:10px">'
                 '<div style="width:9px;height:9px;border-radius:50%;background:' + c + ';box-shadow:0 0 7px ' + c + ';flex-shrink:0"></div>'
                 '<span style="font-size:.82rem;color:#A0A0D0;font-weight:500">' + lbl + '</span>'
                 '<span style="font-size:.78rem;color:#5A5A80;margin-left:auto">' + rng + '</span></div>'
                 for c, lbl, rng in [("#22C55E","Excellent","\u226585"),("#EAB308","Good","65\u201384"),
                                      ("#F97316","Needs Work","40\u201364"),("#EF4444","Poor","<40")])
         + '</div></div>')


def render_result(asin, title, bullets_json, has_aplus, image, total, t_s, b_s, a_s, k_s,
                  t_issues, b_issues, a_issues, k_issues, found_kws, miss_kws, sugg_kws, rule_w, pl_keywords):
    s = total or 0; bullets = json.loads(bullets_json or "[]")
    ...
    img_h = ('<img src="' + (image or "") + '" style="width:76px;height:76px;object-fit:contain;border-radius:12px;border:1px solid rgba(124,58,237,.2);margin-bottom:14px;background:#0F0F20">') if image else ""
    ...
    header = ('<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:24px;margin-bottom:26px;flex-wrap:wrap">'
              '<div style="flex:1;min-width:220px">' + img_h +
              '<div style="display:flex;align-items:center;gap:10px;margin-bottom:12px;flex-wrap:wrap">'
              '<code style="background:rgba(124,58,237,.22);color:#C4B5FD;padding:5px 13px;border-radius:8px;font-size:.85rem;font-weight:700;letter-spacing:.05em">' + asin + '</code>'
              '<span style="background:' + bg_ + ';color:' + tc_ + ';padding:4px 13px;border-radius:20px;font-size:.75rem;font-weight:700">' + lbl_ + '</span>'
              '<a href="https://www.amazon.co.uk/dp/' + asin + '" target="_blank" style="font-size:.78rem;color:#7B7BAA;text-decoration:none;padding:4px 10px;border:1px solid rgba(255,255,255,.1);border-radius:8px">\U0001f517 View on Amazon</a>'
              '</div>'
              '<p style="color:#A0A0D0;font-size:.88rem;margin:0;line-height:1.65;border-left:2px solid rgba(124,58,237,.3);padding-left:12px">' + (title or "\u2014")[:140] + '</p>'
              '</div>' + score_gauge(s) + '</div>')
    show('<div style="background:#10101E;border-radius:22px;padding:28px 32px;border:1px solid rgba(124,58,237,.18);margin:20px 0;box-shadow:0 8px 40px rgba(0,0,0,.4)">'
         + header +
         '<div style="border-top:1px solid rgba(255,255,255,.05);padding-top:20px;margin-top:4px">' + bars + '</div>'
    ...
    if pl_keywords:
        ...
        ghtml = ('<div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:16px">'
                 '<div style="background:rgba(234,179,8,.07);border:1px solid rgba(234,179,8,.22);border-radius:14px;padding:16px 18px">'
                 '<p style="font-size:.7rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#EAB308;margin:0 0 10px">\U0001f4dd Missing from Title</p>')
        ghtml += ("".join(pill(k,"title_miss") for k in t_miss) if t_miss else '<span style="font-size:.82rem;color:#22C55E;font-weight:600">\u2713 All keywords present</span>')
        ghtml += ('</div><div style="background:rgba(249,115,22,.07);border:1px solid rgba(249,115,22,.22);border-radius:14px;padding:16px 18px">'
                  '<p style="font-size:.7rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#F97316;margin:0 0 10px">\U0001f539 Missing from Bullets</p>')
        ghtml += ("".join(pill(k,"bullet_miss") for k in b_miss) if b_miss else '<span style="font-size:.82rem;color:#22C55E;font-weight:600">\u2713 All keywords present</span>')
        ghtml += '</div></div>'; show(ghtml + '</div>')
    if found_kws or miss_kws:
        ...
        show("".join(pill(k,"found") for k in found_kws) + "".join(pill(k,"missing") for k in miss_kws) +
             '<p style="font-size:.72rem;color:#5A5A80;margin:8px 0 0">\u2713 found  \u00b7  \u2717 not found</p></div>')
    if rewrites:
        show('<div style="margin-top:22px;border-top:1px solid rgba(255,255,255,.05);padding-top:20px">' + section_label("\U0001f4a1 Smart rewrite suggestions"))
        for rw in rewrites:
            uid = re.sub(r"\W","_", asin + "_" + rw["keyword"])
            show('<div style="background:#0F0F20;border:1px solid rgba(124,58,237,.18);border-radius:14px;padding:18px 22px;margin-bottom:14px">'
                 ...
                 '<span style="background:rgba(124,58,237,.2);color:#C4B5FD;border-radius:8px;padding:3px 10px;font-size:.82rem;font-weight:700">' + rw["keyword"] + '</span>'
                 '<span style="color:#5A5A80;font-size:.8rem">\u2192 Bullet ' + str(rw["bullet_idx"]+1) + '</span>'
                 '<span style="background:rgba(255,255,255,.05);color:#7B7BAA;border-radius:6px;padding:2px 8px;font-size:.72rem;border:1px solid rgba(255,255,255,.08)">type: ' + rw["bullet_type"] + '</span>'
                 + confidence_badge(rw["confidence"], rw["strategy"]) + '</div>'
                 '<div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">'
                 '<div><p style="font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#5A5A80;margin:0 0 8px">Original Bullet</p>'
                 '<p style="font-size:.84rem;color:#8888C0;line-height:1.6;margin:0;font-style:italic;padding:12px 14px;background:rgba(255,255,255,.03);border-radius:10px;border:1px solid rgba(255,255,255,.07)">' + rw["original"] + '</p></div>'
                 '<div><p style="font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#22C55E;margin:0 0 8px">Suggested Rewrite</p>'
                 '<p style="font-size:.84rem;color:#E8E8FF;line-height:1.6;margin:0;padding:12px 14px;background:rgba(34,197,94,.07);border:1px solid rgba(34,197,94,.22);border-radius:10px">' + rw["suggested"] + '</p>'
...
if page == "\U0001f3e0  Dashboard":
    ...
    if total_a == 0:
        empty_state("\U0001f4e6","No analyses yet","Create a Product Line and run your first analysis.")
    else:
        ...
        show('<h2 style="font-size:1.05rem;font-weight:700;color:#C8C8F0;margin:0 0 14px">Recent Analyses</h2>')
        tbl = ('<div style="background:#10101E;border-radius:20px;border:1px solid rgba(124,58,237,.15);overflow:hidden">'
               '<table style="width:100%;border-collapse:collapse;font-size:.84rem"><thead>'
               '<tr style="background:rgba(124,58,237,.1)">')
        for h in ["ASIN","Product","Score","Title","Bullets","A+","Keywords","Date"]:
            tbl += '<th style="padding:12px 16px;text-align:left;font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.09em;color:#7B7BAA;white-space:nowrap;border-bottom:1px solid rgba(124,58,237,.15)">' + h + '</th>'
        tbl += '</tr></thead><tbody>'
        for r in rows[:15]:
            s = r["total_score"]; c_,bg_,tc_,lbl_ = _score_meta(s)
            sc = ('<span style="background:' + bg_ + ';color:' + tc_ + ';padding:3px 11px;border-radius:20px;font-size:.75rem;font-weight:700">' + str(int(s)) + ' \u2014 ' + lbl_ + '</span>') if s is not None else '<span style="color:#5A5A80">Error</span>'
            ap = ('<span style="color:#22C55E;font-weight:700;font-size:.82rem">\u2713 Yes</span>' if r["has_aplus"] else '<span style="color:#EF4444;font-weight:700;font-size:.82rem">\u2717 No</span>')
            ...
            tbl += ('<tr style="border-bottom:1px solid rgba(255,255,255,.04)">'
                    ...
                    '<td style="padding:12px 16px;color:#8888C0;max-width:170px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">' + (r["product_name"] or "\u2014")[:45] + '</td>'
                    ...
                    '<td style="padding:12px 16px;color:#5A5A80;font-size:.78rem">' + str(r["created_at"] or "")[:10] + '</td></tr>')
        tbl += '</tbody></table></div>'; show(tbl)
...
# ── NEW ANALYSIS ──────────────────────────────────────────────────────────────
    ...
    conn.close()
    if not lines:
        empty_state("\U0001f3f7\ufe0f","No product lines yet","Go to Product Lines, create one with keywords, then come back here.")
        st.stop()
    show('<div style="background:#10101E;border-radius:18px;padding:24px 28px;border:1px solid rgba(124,58,237,.18);margin-bottom:20px">')
    ...
    with col_b:
        ...
        # ✅ FIX: removed "" second positional arg — was causing TypeError
    ...
    if st.button("\u25b6\ufe0f  Run Analysis", type="primary", use_container_width=True):
        ...
        for idx, asin in enumerate(asins):
            bar.progress(idx/max(len(asins),1), text="\U0001f50d Scraping " + asin + " (" + str(idx+1) + "/" + str(len(asins)) + ")\u2026")
            conn = db()
            try:
                ...
                conn.commit()
                render_result(asin,scraped.get("title"),json.dumps(scraped.get("bullets",[])),scraped.get("has_aplus"),scraped.get("image_url"),
                              result["total_score"],result["title_score"],result["bullets_score"],result["aplus_score"],result["keywords_score"],
                              result["title_issues"],result["bullets_issues"],result["aplus_issues"],result["keywords_issues"],
                              result["found_keywords"],result["missing_keywords"],result["suggested_keywords"],rule_dict,keywords)
                ...
                conn.commit()
                show('<div style="background:rgba(239,68,68,.1);border:1px solid rgba(239,68,68,.3);border-left:3px solid #EF4444;border-radius:0 10px 10px 0;padding:12px 16px;margin:8px 0">'
                     '<span style="color:#FCA5A5;font-weight:600">' + asin + '</span><span style="color:#7B7BAA;font-size:.85rem"> \u2014 ' + str(e) + '</span></div>')
            finally: conn.close()
...
# ── HISTORY ───────────────────────────────────────────────────────────────────
    ...
    if not rows:
        ...
        xl = build_excel(rows)
        hc2.download_button("\u2193  Export to Excel", data=xl, file_name="amazon_analysis.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", use_container_width=True)
        show('<div style="height:12px"></div>')
        for r in rows:
            s = r["total_score"]; c_,bg_,tc_,lbl_ = _score_meta(s)
            score_str = str(int(s)) + "/100  " + lbl_ if s is not None else "Error"
            exp_label = r["asin"] + "  \u2014  " + score_str + "  \u00b7  " + (r["product_name"] or "\u2014")[:38] + "  \u00b7  " + str(r["created_at"] or "")[:10]
            with st.expander(exp_label):
                if r["scrape_error"]:
                    show('<div style="background:rgba(239,68,68,.1);border:1px solid rgba(239,68,68,.3);border-radius:10px;padding:12px 16px;margin-bottom:12px">'
                    ...
                    c2 = db()
                    if st.button("\U0001f5d1  Delete", key="del_"+str(r["id"])): c2.execute("DELETE FROM results WHERE id=?",(r["id"],)); c2.commit(); st.rerun()
                    c2.close(); continue
...
# ── PRODUCT LINES ─────────────────────────────────────────────────────────────
    ...
    with st.expander("\u2795  Create new product line", expanded=len(lines)==0):
        ...
        with c1: new_name = st.text_input("Product line name", placeholder="e.g. Coffee Machines")
        new_kws = st.text_area("Keywords", placeholder="One per line or comma-separated:\ncoffee machine\nespresso maker", height=190)
        kc = len([k.strip() for k in re.split(r"[,\n]+", new_kws) if k.strip()])
        ca,cb = st.columns([1,4]); ca.caption(str(kc) + " keywords")
        if cb.button("Create product line", type="primary", key="cpl"):
            if not new_name.strip(): st.error("Please enter a name.")
            else:
    ...
    if not lines: empty_state("\U0001f3f7\ufe0f","No product lines yet","Use the form above to create your first one.")
    for line in lines:
        kws = json.loads(line["keywords"])
        with st.expander(line["name"] + "  \u00b7  " + str(len(kws)) + " keywords"):
            show("".join(pill(k,"suggest") for k in kws[:30]) + (' <span style="color:#7B7BAA;font-size:.78rem">+' + str(len(kws)-30) + ' more</span>' if len(kws)>30 else ""))
            show('<div style="height:10px"></div>')
            c1,c2 = st.columns([1,1],gap="large")
...
# ── SCORING RULES ─────────────────────────────────────────────────────────────
    ...
    page_header("Scoring Rules","Configure how listings are evaluated")
    ...
    with st.expander("\u2795  Create new scoring rule"):
        ...
        show('<div style="background:' + ("rgba(34,197,94,.08)" if ok else "rgba(239,68,68,.08)") +
             ...
             + ("\u2713 Weights sum to 100" if ok else "\u26a0\ufe0f Total is " + str(tw_) + "/100 \u2014 must equal 100") + '</div>')
        cx,cy = st.columns(2,gap="large")
        with cx:
            show(section_label("Title rules")); tca,tcb=st.columns(2)
        ...
        with cy:
            show(section_label("Bullet rules")); bca,bcb,bcc=st.columns(3)
            ...
            show(section_label("Keyword rules")); kmc=st.slider("Min coverage %",0,100,70,key="nkmc")
        ...
        with st.expander(rule["name"] + (" \u2605 Default" if rule["is_default"] else "")):
            show('<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:10px">'
                 ...
                 + "".join('<div style="display:flex;justify-content:space-between;align-items:center">'
                           ...
                           '<span style="font-size:.9rem;font-weight:700;color:#C4B5FD">' + str(v) + '%</span></div>'
                           for n,v in [("Title",rule["title_weight"]),("Bullets",rule["bullets_weight"]),("A+ Content",rule["aplus_weight"]),("Keywords",rule["keywords_weight"])])
                 + '</div></div>'
                 '<div style="background:#0F0F20;border:1px solid rgba(124,58,237,.15);border-radius:12px;padding:16px 18px">'
                 ...
                 + "".join('<div style="display:flex;justify-content:space-between;align-items:center">'
                           '<span style="font-size:.84rem;color:#A0A0D0">' + n + '</span>'
                           '<span style="font-size:.84rem;font-weight:600;color:#C4B5FD">' + v + '</span></div>'
                           for n,v in [("Title length",str(rule["title_min_length"])+"\u2013"+str(rule["title_max_length"])+" chars"),
            ...
            if not rule["is_default"]:
                if st.button("\U0001f5d1  Delete rule", key="rd_"+str(rule["id"])): conn.execute("DELETE FROM scoring_rules WHERE id=?",(rule["id"],)); conn.commit(); st.rerun()
    conn.close()
